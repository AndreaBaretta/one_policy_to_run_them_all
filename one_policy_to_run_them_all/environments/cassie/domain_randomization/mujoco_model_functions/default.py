...
class DefaultDomainMuJoCoModel:
    ...
    def init(self):
        ...
        self.sampled_friction_torsional_feet = self.env.model.geom_friction[44, 1]
        self.sampled_friction_rolling_ground = self.env.model.geom_friction[0, 2]
        self.sampled_friction_rolling_feet = self.env.model.geom_friction[44, 2]
    ...
    def sample(self):
        ...
        self.env.model.geom_friction[[24, 44]] = [self.sampled_friction_tangential, self.sampled_friction_torsional_feet, self.sampled_friction_rolling_feet]
