...
class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-1.2, add_trunk_mass_max=1.2,
        add_com_displacement_min=-0.0025, add_com_displacement_max=0.0025,
        foot_size_min=0.0185, foot_size_max=0.0215,
        ...
        joint_armature_min=0.01, joint_armature_max=0.1,
        joint_stiffness_min=0.0, joint_stiffness_max=0.5,
        joint_friction_loss_min=0.0, joint_friction_loss_max=0.2,
        add_p_gain_min=-4.0, add_p_gain_max=4.0,
        add_d_gain_min=-0.2, add_d_gain_max=0.2,  
        add_scaling_factor_min=-0.05, add_scaling_factor_max=0.05,     
    ):
        self.env = env
